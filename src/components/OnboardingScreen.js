...
const OnboardingScreen = () => {
  ...
  const [theme, setTheme] = useState('dark'); // Track the selected theme
  ...
  const handleSocialClick = () => {
    setStep(3); // Move to the third screen after clicking any social button
  };
    ...
    <OnboardingContainer>
      ...
      {step === 2 && (
        <GlassPanel>
          ...
          <ButtonContainer>
            <SocialButton bgColor="#fff" textColor="#000" onClick={handleSocialClick}>
              <Icon src="https://upload.wikimedia.org/wikipedia/commons/5/53/Google_%22G%22_Logo.svg" alt="Google" />
              Connect Google
            </SocialButton>
            <SocialButton bgColor="#000" textColor="#fff" onClick={handleSocialClick}>
              <Icon src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" alt="Apple" />
              Connect Apple
            </SocialButton>
            <SocialButton bgColor="#1877F2" textColor="#fff" onClick={handleSocialClick}>
